...
A **WebSite App** is under development to simplify deployment of the featurization stack (multiple deep learning back ends). Until it is published, use `cmd_fp.yml` and the [DeepFP_Prep](DeepFP_Prep/README.md) documentation.
